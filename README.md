...
**🤖 AI/ML Engineer | 🧠 Generative AI & RAG Architect**
...
🎓 Currently pursuing my B.Tech in Computer Science Engineering (Class of 2026).

### 🛠️ Core Tech Stack
- **🧠 AI & Machine Learning:** PyTorch, LangChain, TensorFlow, Llama 3, Hugging Face, Transformers, OpenCV
- **⚙️ Backend & Vector Databases:** Python, FastAPI, Qdrant, FAISS, SQL, REST APIs
- **🐳 Infrastructure & DevOps:** Docker, Linux, Git, Microsoft Azure

### 🚀 Featured Projects

* **[🎯 Nexus AI - Agentic Talent Intelligence ATS](https://github.com/deepanshu9012/nexus-ai-ats)**
